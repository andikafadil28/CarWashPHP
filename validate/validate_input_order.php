...
$jenis_Kendaraan = (isset($_POST["ukuran_Kendaraan"])) ? htmlentities($_POST["ukuran_Kendaraan"]) : "";
...
if (isset($_POST['input_order_proses'])) {
        ...
        if (mysqli_num_rows($select_query) > 0) {
                ...
                if ($query) {
                        $message =  '<script> window.location.href="../?x=orderitem&kode_order=' . $kodeorder . '&no_Kendaraan=' . $no_Kendaraan . '&pelanggan=' . $pelanggan . '&ukuran_Kendaraan=' . $ukuran_Kendaraan . '$jenis_Kendaraan=' . $jenis_Kendaraan . '";</script>';
                } else {
